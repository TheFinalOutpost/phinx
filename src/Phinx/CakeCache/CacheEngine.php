...
abstract class CacheEngine implements CacheInterface, CacheEngineInterface
{
     ...
     * @return void
     * @throws \Phinx\CakeCache\InvalidArgumentException When the key is not valid.
     */
     ...
     * @throws \Phinx\CakeCache\InvalidArgumentException If $keys is neither an array nor a Traversable,
     ...
     * @throws \Phinx\CakeCache\InvalidArgumentException If $values is neither an array nor a Traversable,
     ...
     * @return bool
     * @throws \Phinx\CakeCache\InvalidArgumentException If the $key string is not a legal value.
     */
     ...
     * @throws \Phinx\CakeCache\InvalidArgumentException If key's value is invalid.
     */
