 ...
 *
 * @extends \Cake\Core\ObjectRegistry<\Phinx\CakeCache\CacheEngine>
 */
class CacheRegistry extends ObjectRegistry
{
     ...
     * Part of the template method for Cake\Core\ObjectRegistry::load()
     *
     * @param string|\Phinx\CakeCache\CacheEngine $class The classname or object to make.
     * @param string $alias The alias of the object.
     * @param array $config An array of settings to use for the cache engine.
     * @return \Phinx\CakeCache\CacheEngine The constructed CacheEngine class.
