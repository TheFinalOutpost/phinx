 ...
 */
namespace Phinx\CakeCache;

use InvalidArgumentException;
use Phinx\CakeCache\Engine\NullEngine;
...
class Cache
{
     ...
     *
     * @var \Phinx\CakeCache\CacheRegistry|null
     */
     ...
     *
     * @return \Phinx\CakeCache\CacheRegistry
     */
     ...
     *
     * @param \Phinx\CakeCache\CacheRegistry $registry Injectable registry object.
     * @return void
     */
     ...
     * @throws \Phinx\CakeCache\InvalidArgumentException When a cache engine cannot be created.
     */
    protected static function _buildEngine(string $name): void
    {
        ...
        try {
            ...
            /** @var \Phinx\CakeCache\CacheEngine $fallbackEngine */
     ...
     * @return \Psr\SimpleCache\CacheInterface&\Phinx\CakeCache\CacheEngineInterface
     ...
     * @throws \Phinx\CakeCache\InvalidArgumentException
     */
     ...
     *    or if there was an error fetching it.
     * @throws \Phinx\CakeCache\InvalidArgumentException When offset < 0
     */
