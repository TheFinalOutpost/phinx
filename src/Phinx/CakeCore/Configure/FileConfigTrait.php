...
trait FileConfigTrait
{
    ...
    {
        if (strpos($key, '..') !== false) {
            throw new RuntimeException('Cannot load/dump configuration files with ../ in them.');
        }
        ...
        throw new RuntimeException(sprintf('Could not load configuration file: %s', $file));
    }
}
