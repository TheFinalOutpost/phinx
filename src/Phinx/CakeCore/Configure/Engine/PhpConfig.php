 ...
 * ```
 *
 * @see \Phinx\CakeCore\Configure::load() for how to load custom configuration files.
 */
class PhpConfig implements ConfigEngineInterface
{
    ...
    public function read(string $key): array
    {
        ...
        throw new RuntimeException(sprintf('Config file "%s" did not return an array', $key . '.php'));
    }
