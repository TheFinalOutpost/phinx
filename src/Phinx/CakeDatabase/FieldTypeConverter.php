...
use Phinx\CakeDatabase\Type\BatchCastingInterface;
use Phinx\CakeDatabase\Type\OptionalConvertInterface;
...
class FieldTypeConverter
{
     ...
     *
     * @var \Phinx\CakeDatabase\TypeInterface[]
     */
    protected $_typeMap;
     ...
     *
     * @var \Phinx\CakeDatabase\TypeInterface[]|\Phinx\CakeDatabase\Type\BatchCastingInterface[]
     */
    protected $types;
     ...
     * Builds the type map
     *
     * @param \Phinx\CakeDatabase\TypeMap $typeMap Contains the types to use for converting results
     * @param \Phinx\CakeDatabase\DriverInterface $driver The driver to use for the type conversion
     */
