...
class TypeFactory
{
     ...
     * @psalm-var array<string, class-string<\Phinx\CakeDatabase\TypeInterface>>
     */
     ...
     * @return \Phinx\CakeDatabase\TypeInterface
     ...
     * @param \Phinx\CakeDatabase\TypeInterface $instance The type instance you want to set.
     * @return void
     */
     ...
     * @return void
     * @psalm-param class-string<\Phinx\CakeDatabase\TypeInterface> $className
     */
     ...
     * @return void
     * @psalm-param array<string, class-string<\Phinx\CakeDatabase\TypeInterface>> $map
     */
