 ...
 */
namespace Phinx\CakeDatabase\Expression;

use Closure;
use Countable;
use InvalidArgumentException;
use Phinx\CakeDatabase\ExpressionInterface;
use Phinx\CakeDatabase\Query;
use Phinx\CakeDatabase\TypeMapTrait;
use Phinx\CakeDatabase\ValueBinder;
...
class QueryExpression implements ExpressionInterface, Countable
{
     ...
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions Tree like array structure
     * containing all the conditions to be added or nested inside this expression object.
     * @param array|\Phinx\CakeDatabase\TypeMap $types associative array of types to be associated with the values
     * passed in $conditions.
     * @param string $conjunction the glue that will join all the string conditions at this
     * level of the expression tree. For example "AND", "OR", "XOR"...
     * @see \Phinx\CakeDatabase\Expression\QueryExpression::add() for more details on $conditions and $types
     */
     ...
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions single or multiple conditions to
     ...
     * @return $this
     * @see \Phinx\CakeDatabase\Query::where() for examples on conditions
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field Database field to be compared against value
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field database field to be
     * tested for null
     * @return $this
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field Database field to be compared against value
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $values the value to be bound to $field for comparison
     * @param string|null $type the type name for $value as configured using the Type map.
     * @return $this
     */
     ...
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface $conditions The conditions to test. Must be a ExpressionInterface
     * instance, or an array of ExpressionInterface instances.
     * @param array|\Phinx\CakeDatabase\ExpressionInterface $values associative array of values to be associated with the
     ...
     *
     * @param \Phinx\CakeDatabase\ExpressionInterface $expression the inner query
     * @return $this
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field The field name to compare for values inbetween the range.
     ...
     *
     * @param \Closure|string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions to be joined with AND
     * @param array $types associative array of fields pointing to the type of the
     * values that are being passed. Used for correctly binding values to statements.
     ...
     *
     * @param \Closure|string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions to be joined with OR
     * @param array $types associative array of fields pointing to the type of the
     * values that are being passed. Used for correctly binding values to statements.
     * @return \Phinx\CakeDatabase\Expression\QueryExpression
     */
     ...
     *
     * @param string|array|\Closure|\Phinx\CakeDatabase\ExpressionInterface $conditions to be added and negated
     * @param array $types associative array of fields pointing to the type of the
     * values that are being passed. Used for correctly binding values to statements.
     * @return $this
     */
     ...
     *
     * @param callable|string|array|\Phinx\CakeDatabase\ExpressionInterface $callable The callable to check.
     ...
     * @return string|\Phinx\CakeDatabase\ExpressionInterface
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field The field name to get a type for.
