...
class CommonTableExpression implements ExpressionInterface
{
     ...
     * The CTE name.
     *
     * @var \Phinx\CakeDatabase\Expression\IdentifierExpression
     */
    protected $name;
     ...
     *
     * @var \Phinx\CakeDatabase\ExpressionInterface|null
     */
    protected $query;
     ...
     * @param \Closure|\Phinx\CakeDatabase\ExpressionInterface $query CTE query
     */
     ...
     *
     * @param string|string[]|\Phinx\CakeDatabase\Expression\IdentifierExpression|\Phinx\CakeDatabase\Expression\IdentifierExpression[] $fields Field names
     * @return $this
     */
