...
interface WindowInterface
{
     ...
     *
     * @param \Closure|(\Phinx\CakeDatabase\ExpressionInterface|string)[]|\Phinx\CakeDatabase\ExpressionInterface|string $partitions Partition expressions
     * @return $this
     */
     ...
     *
     * @param \Closure|(\Phinx\CakeDatabase\ExpressionInterface|string)[]|\Phinx\CakeDatabase\ExpressionInterface|string $fields Order expressions
     * @return $this
     */
     ...
     *
     * @param int|string|\Phinx\CakeDatabase\ExpressionInterface|null $start Frame start
     * @param int|string|\Phinx\CakeDatabase\ExpressionInterface|null $end Frame end
     ...
     * @param int|string|\Phinx\CakeDatabase\ExpressionInterface|null $startOffset Frame start offset
     * @param string $startDirection Frame start direction
     * @param int|string|\Phinx\CakeDatabase\ExpressionInterface|null $endOffset Frame end offset
