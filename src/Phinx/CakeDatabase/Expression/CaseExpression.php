...
use Phinx\CakeDatabase\Type\ExpressionTypeCasterTrait;
...
class CaseExpression implements ExpressionInterface
{
     ...
     *
     * @var string|\Phinx\CakeDatabase\ExpressionInterface|array|null
     */
     ...
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface $conditions Must be a ExpressionInterface instance,
     *   or an array of ExpressionInterface instances.
     * @param array|\Phinx\CakeDatabase\ExpressionInterface $values associative array of values of each condition
     * @param array $types associative array of types to be associated with the values
     * @return $this
     */
     ...
     *
     * @param \Phinx\CakeDatabase\ExpressionInterface|string|array|null $value Value to set
     ...
     *
     * @param array|string|\Phinx\CakeDatabase\ExpressionInterface $part The part to compile
     * @param \Phinx\CakeDatabase\ValueBinder $binder Sql generator
     * @return string
     */
     ...
     *
     * @param \Phinx\CakeDatabase\ValueBinder $binder Placeholder generator object
     * @return string
     */
