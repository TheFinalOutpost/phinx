...
use Phinx\CakeDatabase\TypeMap;
...
class ValuesExpression implements ExpressionInterface
{
     ...
     *
     * @var \Phinx\CakeDatabase\Query|null
     */
    protected $_query;
     ...
     * @param \Phinx\CakeDatabase\TypeMap $typeMap A dictionary of column -> type names
     */
     ...
     *
     * @param array|\Phinx\CakeDatabase\Query $values Array of data to append into the insert, or
     *   a query for doing INSERT INTO .. SELECT style commands
     * @return void
     * @throws \Phinx\CakeDatabase\Exception\DatabaseException When mixing array + Query data types.
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to set
     * @return $this
     */
     ...
     * to insert records in the table.
     *
     * @return \Phinx\CakeDatabase\Query|null
     */
    ...
    protected function _processExpressions(): void
    {
        ...
        foreach ($this->_values as $row => $values) {
            foreach ($types as $col => $type) {
                /** @var \Phinx\CakeDatabase\Type\ExpressionTypeInterface $type */
