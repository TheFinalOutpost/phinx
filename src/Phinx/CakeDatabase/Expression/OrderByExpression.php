...
class OrderByExpression extends QueryExpression
{
     ...
     * Constructor
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions The sort columns
     * @param array|\Phinx\CakeDatabase\TypeMap $types The types for each column.
