...
use Phinx\CakeDatabase\TypedResultInterface;
use Phinx\CakeDatabase\TypedResultTrait;
...
class FunctionExpression extends QueryExpression implements TypedResultInterface
{
     ...
     *@see \Phinx\CakeDatabase\Expression\FunctionExpression::__construct() for more details.
     */
