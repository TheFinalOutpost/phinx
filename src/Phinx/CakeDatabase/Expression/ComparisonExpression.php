...
class ComparisonExpression implements ExpressionInterface, FieldInterface
{
     ...
     *
     * @var \Phinx\CakeDatabase\ExpressionInterface[]
     */
     ...
     * Constructor
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $field the field name to compare to a value
    ...
    {
        /** @var string|\Phinx\CakeDatabase\ExpressionInterface $field */
        $field = $this->_field;
     ...
     *
     * @param \Phinx\CakeDatabase\ValueBinder $binder The value binder to use.
     ...
     * position.
     *
     * @param iterable|\Phinx\CakeDatabase\ExpressionInterface $values The rows to insert
     * @return array
     */
...
class_alias('Phinx\CakeDatabase\Expression\ComparisonExpression', 'Phinx\CakeDatabase\Expression\Comparison');
// phpcs:enable
