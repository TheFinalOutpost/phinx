...
class TupleComparison extends ComparisonExpression
{
     ...
     * Constructor
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $fields the fields to use to form a tuple
     * @param array|\Phinx\CakeDatabase\ExpressionInterface $values the values to use to form a tuple
     ...
     *
     * @param \Phinx\CakeDatabase\ValueBinder $binder The value binder to convert expressions with.
     * @return string
     */
