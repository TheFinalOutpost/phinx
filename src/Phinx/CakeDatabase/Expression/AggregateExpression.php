...
{
    /**
     * @var \Phinx\CakeDatabase\Expression\QueryExpression
     */
    protected $filter;

    /**
     * @var \Phinx\CakeDatabase\Expression\WindowExpression
     */
    protected $window;
     ...
     * `Query::where()`.
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure $conditions The conditions to filter on.
