...
class QueryCompiler
{
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query that is being compiled
     * @param \Phinx\CakeDatabase\ValueBinder $binder Value binder used to generate parameter placeholders
     * @return string
     */
     ...
     * @param \Phinx\CakeDatabase\Query $query The query that is being compiled
     * @param \Phinx\CakeDatabase\ValueBinder $binder Value binder used to generate parameter placeholder
     * @return \Closure
     */
