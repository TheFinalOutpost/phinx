...
class CallbackStatement extends StatementDecorator
{
     ...
     * Constructor
     *
     * @param \Phinx\CakeDatabase\StatementInterface $statement The statement to decorate.
     * @param \Phinx\CakeDatabase\DriverInterface $driver The driver instance used by the statement.
