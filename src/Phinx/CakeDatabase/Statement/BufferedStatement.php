...
use Phinx\CakeDatabase\TypeConverterTrait;
...
class BufferedStatement implements Iterator, StatementInterface
{
     ...
     *
     * @var \Phinx\CakeDatabase\StatementInterface
     */
    protected $statement;
     ...
     * Constructor
     *
     * @param \Phinx\CakeDatabase\StatementInterface $statement Statement implementation such as PDOStatement
     * @param \Phinx\CakeDatabase\DriverInterface $driver Driver instance
     */
