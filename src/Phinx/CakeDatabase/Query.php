...
use Phinx\CakeDatabase\Exception\DatabaseException;
use Phinx\CakeDatabase\Expression\CommonTableExpression;
use Phinx\CakeDatabase\Expression\IdentifierExpression;
use Phinx\CakeDatabase\Expression\OrderByExpression;
use Phinx\CakeDatabase\Expression\OrderClauseExpression;
use Phinx\CakeDatabase\Expression\QueryExpression;
use Phinx\CakeDatabase\Expression\ValuesExpression;
use Phinx\CakeDatabase\Expression\WindowExpression;
use Phinx\CakeDatabase\Statement\CallbackStatement;
...
class Query implements ExpressionInterface, IteratorAggregate
{
     ...
     *
     * @var \Phinx\CakeDatabase\Connection
     */
     ...
     *
     * @var \Phinx\CakeDatabase\StatementInterface|null
     */
    protected $_iterator;
     ...
     *
     * @var \Phinx\CakeDatabase\ValueBinder|null
     */
     ...
     *
     * @var \Phinx\CakeDatabase\FunctionsBuilder|null
     */
     ...
     *
     * @var \Phinx\CakeDatabase\TypeMap|null
     */
     ...
     * Constructor.
     *
     * @param \Phinx\CakeDatabase\Connection $connection The connection
     ...
     *
     * @param \Phinx\CakeDatabase\Connection $connection Connection instance
     * @return $this
     */
     ...
     *
     * @return \Phinx\CakeDatabase\StatementInterface
     */
     ...
     * prepared statements.
     *
     * @param \Phinx\CakeDatabase\ValueBinder|null $binder Value binder that generates parameter placeholders
     * @return string
     */
     ...
     * ```
     *
     * @param \Closure|\Phinx\CakeDatabase\Expression\CommonTableExpression $cte The CTE to add.
     ...
     * from the table.
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface|string|callable $fields fields to be added to the list.
     ...
     * ```
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface|string|bool $on Enable/disable distinct class
     ...
     * ```
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface|string $modifiers modifiers to be applied to the query
     ...
     * @return $this
     * @see \Phinx\CakeDatabase\TypeFactory
     */
     ...
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface $conditions The conditions
     * to use for joining.
     ...
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure|null $conditions The conditions to filter on.
     * @param array $types associative array of type names used to bind values to query
     * @param bool $overwrite whether to reset conditions with passed list or not
     * @return $this
     * @see \Phinx\CakeDatabase\Expression\QueryExpression
     * @see \Phinx\CakeDatabase\TypeFactory
     */
     ...
     *
     * @param array|string|\Phinx\CakeDatabase\ExpressionInterface $fields A single field or expressions or a list of them
     ...
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure $conditions The conditions to add with AND.
     * @param array $types associative array of type names used to bind values to query
     * @return $this
     * @see \Phinx\CakeDatabase\TypeFactory
     * @see \Phinx\CakeDatabase\Query::where()
     */
     ...
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface|\Closure|string $fields fields to be added to the list
     * @param bool $overwrite whether to reset order with field list or not
     * @return $this
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\Expression\QueryExpression|\Closure $field The field to order on.
     ...
     * not sanitized by the query builder.
     *
     * @param array|\Phinx\CakeDatabase\ExpressionInterface|string $fields fields to be added to the list
     * @param bool $overwrite whether to reset fields with passed list or not
     * @return $this
     */
     ...
     * not sanitized by the query builder.
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure|null $conditions The having conditions.
     * @param array $types associative array of type names used to bind values to query
     * @param bool $overwrite whether to reset conditions with passed list or not
     * @return $this
     * @see \Phinx\CakeDatabase\Query::where()
     ...
     * not sanitized by the query builder.
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure $conditions The AND conditions for HAVING.
     * @param array $types associative array of type names used to bind values to query
     * @return $this
     * @see \Phinx\CakeDatabase\Query::andWhere()
     */
     ...
     * @param \Phinx\CakeDatabase\Expression\WindowExpression|\Closure $window Window expression
     ...
     * ```
     *
     * @param int|\Phinx\CakeDatabase\ExpressionInterface|null $num number of records to be returned
     * @return $this
     */
     ...
     * ```
     *
     * @param int|\Phinx\CakeDatabase\ExpressionInterface|null $num number of records to be skipped
     * @return $this
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\Query $query full SQL query to be used in UNION operator
     ...
     * @return \Phinx\CakeDatabase\ExpressionInterface
     */
     ...
     *
     * @param array|\Phinx\CakeDatabase\Query|\Phinx\CakeDatabase\Expression\ValuesExpression $data The data to insert.
     * @return $this
     * @throws \Phinx\CakeDatabase\Exception\DatabaseException if you try to set values before declaring columns.
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface $table The table you want to update.
     * @return $this
     */
     ...
     * ```
     *
     * @param string|array|\Closure|\Phinx\CakeDatabase\Expression\QueryExpression $key The column name or array of keys
     ...
     *
     * @param string|\Phinx\CakeDatabase\ExpressionInterface|null $expression The expression to be appended
     * @return $this
     */
     ...
     * ```
     *
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|null $rawExpression A string, array or anything you want wrapped in an expression object
     * @return \Phinx\CakeDatabase\Expression\QueryExpression
     */
     ...
     * ```
     *
     * @return \Phinx\CakeDatabase\FunctionsBuilder
     */
     ...
     *
     * @param \Phinx\CakeDatabase\ExpressionInterface|\Phinx\CakeDatabase\ExpressionInterface[] $expression Query expression or
     ...
     *
     * @return \Phinx\CakeDatabase\ValueBinder
     */
     ...
     * to the statement object.
     *
     * @param \Phinx\CakeDatabase\ValueBinder|null $binder The binder or null to disable binding.
     * @return $this
     */
     ...
     *
     * @param \Phinx\CakeDatabase\TypeMap $typeMap The map object to use
     * @return $this
     */
     ...
     * select clause are stored.
     *
     * @return \Phinx\CakeDatabase\TypeMap
     */
     ...
     *
     * @param \Phinx\CakeDatabase\StatementInterface $statement to be decorated
     * @return \Phinx\CakeDatabase\Statement\CallbackStatement|\Phinx\CakeDatabase\StatementInterface
     */
     ...
     * @param string|array|\Phinx\CakeDatabase\ExpressionInterface|\Closure|null $append Expression or builder function to append.
     *   to append.
