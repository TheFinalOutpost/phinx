...
class SchemaCache
{
     ...
     * Schema
     *
     * @var \Phinx\CakeDatabase\Schema\CachedCollection
     */
    protected $_schema;
     ...
     * Constructor
     *
     * @param \Phinx\CakeDatabase\Connection $connection Connection name to get the schema for or a connection instance
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Connection $connection Connection object
     * @return \Phinx\CakeDatabase\Schema\CachedCollection
    ...
    public function getSchema(Connection $connection): CachedCollection
    {
        ...
        /** @var \Phinx\CakeDatabase\Schema\CachedCollection $schemaCollection */
