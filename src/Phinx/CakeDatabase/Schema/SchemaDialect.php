...
abstract class SchemaDialect
{
     ...
     *
     * @param \Phinx\CakeDatabase\DriverInterface $driver The driver to use.
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema Schema instance
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema The table object to append fields to.
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema The table object to append
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema Table instance.
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema The table instance the column is in.
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema The table instance the foreign key constraints are.
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\TableSchema $schema The table object the column is in.
     * @param string $name The name of the column.
     * @return string SQL fragment.
     */
