...
use Closure;
use Phinx\CakeDatabase\Expression\ComparisonExpression;
use Phinx\CakeDatabase\Expression\IdentifierExpression;
use Phinx\CakeDatabase\IdentifierQuoter;
...
trait SqlDialectTrait
{
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to translate
     * @return \Phinx\CakeDatabase\Query The modified query
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to be transformed
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to process.
     * @return \Phinx\CakeDatabase\Query The modified query.
