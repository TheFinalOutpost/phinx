...
use Phinx\CakeDatabase\Expression\UnaryExpression;
use Phinx\CakeDatabase\ExpressionInterface;
use Phinx\CakeDatabase\Query;
use Phinx\CakeDatabase\QueryCompiler;
use Phinx\CakeDatabase\Schema\SchemaDialect;
use Phinx\CakeDatabase\Schema\SqlserverSchemaDialect;
use Phinx\CakeDatabase\SqlserverCompiler;
use Phinx\CakeDatabase\Statement\SqlserverStatement;
use Phinx\CakeDatabase\StatementInterface;
...
class Sqlserver extends Driver
{
     ...
     *
     * @var \Phinx\CakeDatabase\Schema\SqlserverSchemaDialect|null
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\Query $query The query to prepare.
     ...
     * {@inheritDoc}
     *
     * @return \Phinx\CakeDatabase\SqlserverCompiler
     */
     ...
     * be used.
     *
     * @param \Phinx\CakeDatabase\Query $original The query to wrap in a subquery.
     * @param int|null $limit The number of rows to fetch.
     * @param int|null $offset The number of rows to offset.
     * @return \Phinx\CakeDatabase\Query Modified query object.
     */
     ...
     * SQL dialect.
     *
     * @param \Phinx\CakeDatabase\Expression\FunctionExpression $expression The function expression to convert to TSQL.
     * @return void
     */
