...
use Phinx\CakeDatabase\Expression\FieldInterface;
...
class IdentifierQuoter
{
     ...
     * Constructor
     *
     * @param \Phinx\CakeDatabase\Driver $driver The driver instance used to do the identifier quoting
     */
     ...
     * quotes them
     *
     * @param \Phinx\CakeDatabase\Query $query The query to have its identifiers quoted
     ...
     *
     * @param \Phinx\CakeDatabase\ExpressionInterface $expression The expression object to walk and quote.
     * @return void
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to quote.
     * @return void
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The insert query to quote.
     * @return void
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The update query to quote.
     * @return void
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Expression\FieldInterface $expression The expression to quote.
     * @return void
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Expression\OrderByExpression $expression The expression to quote.
     * @return void
     */
     ...
     * Quotes identifiers in "order by" expression objects
     *
     * @param \Phinx\CakeDatabase\Expression\IdentifierExpression $expression The identifiers to quote.
     * @return void
     */
