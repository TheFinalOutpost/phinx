...
use Phinx\CakeDatabase\Exception\NestedTransactionRollbackException;
use Phinx\CakeDatabase\Log\LoggedQuery;
use Phinx\CakeDatabase\Log\LoggingStatement;
use Phinx\CakeDatabase\Log\QueryLogger;
use Phinx\CakeDatabase\Retry\ReconnectStrategy;
use Phinx\CakeDatabase\Schema\CachedCollection;
use Phinx\CakeDatabase\Schema\Collection as SchemaCollection;
use Phinx\CakeDatabase\Schema\CollectionInterface as SchemaCollectionInterface;
...
class Connection
{
     ...
     *
     * @var \Phinx\CakeDatabase\DriverInterface
     */
    protected $_driver;
     ...
     *
     * @var \Phinx\CakeDatabase\Schema\CollectionInterface|null
     */
     ...
     *
     * @var \Phinx\CakeDatabase\Exception\NestedTransactionRollbackException|null
     */
     ...
     *
     * @param \Phinx\CakeDatabase\DriverInterface|string $driver The driver instance to use.
     * @param array $config Config for a new driver.
     * @return $this
     * @throws \Phinx\CakeDatabase\Exception\MissingExtensionException When a driver's PHP extension is missing.
     * @throws \Phinx\CakeDatabase\Exception\MissingDriverException When a driver class is missing.
     */
    public function setDriver($driver, $config = [])
    {
        if (is_string($driver)) {
            /** @psalm-var class-string<\Phinx\CakeDatabase\DriverInterface>|null $className */
     ...
     *
     * @return \Phinx\CakeDatabase\DriverInterface
     */
     ...
     * @throws \Phinx\CakeDatabase\Exception\MissingConnectionException If database connection could not be established.
     */
     ...
     *
     * @param string|\Phinx\CakeDatabase\Query $query The SQL to convert into a prepared statement.
     ...
     * @return \Phinx\CakeDatabase\StatementInterface executed statement
     */
     ...
     * connection's driver
     *
     * @param \Phinx\CakeDatabase\Query $query The query to be compiled
     * @param \Phinx\CakeDatabase\ValueBinder $binder Value binder
     * @return string
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Query $query The query to be executed
     * @return \Phinx\CakeDatabase\StatementInterface executed statement
     */
     ...
     *
     * @param \Phinx\CakeDatabase\Schema\CollectionInterface $collection The schema collection object
     * @return $this
     */
     ...
     *
     * @return \Phinx\CakeDatabase\Schema\CollectionInterface
     */
    ...
    public function commit(): bool
    {
        ...
        if ($this->_transactionLevel === 0) {
            if ($this->wasNestedTransactionRolledback()) {
                /** @var \Phinx\CakeDatabase\Exception\NestedTransactionRollbackException $e */
     ...
     * @param string|int|\Phinx\CakeDatabase\TypeInterface $type Type to be used for determining kind of quoting to perform
     ...
     *
     * @param \Phinx\CakeDatabase\StatementInterface $statement the instance to be decorated
     * @return \Phinx\CakeDatabase\Log\LoggingStatement
     */
