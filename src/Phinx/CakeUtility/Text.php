...
class Text
{
     ...
     * @return string
     * @see \Phinx\CakeUtility\Text::insert()
     */
     ...
     * @param array $options An array of HTML attributes and options.
     * @return string Trimmed string.
     * @see \Phinx\CakeUtility\Text::truncate()
     */
    ...
    public static function setTransliteratorId(string $transliteratorId): void
    {
        ...
        if ($transliterator === null) {
            throw new RuntimeException('Unable to create transliterator for id: ' . $transliteratorId);
        }
    ...
    public static function transliterate(string $string, $transliterator = null): string
    {
        ...
        if ($return === false) {
            throw new RuntimeException(sprintf('Unable to transliterate string: %s', $string));
        }
